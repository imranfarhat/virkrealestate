    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <h3 class="text-center">Feature Ads</h3>
                <table class="table table-bordered table-striped text-center">
                    <thead class="thead">
                        <tr>
                            ...
                            <th style='vertical-align:middle'>Views</th>
                            <th colspan="5" style='vertical-align:middle'>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        $query = "SELECT * FROM ads WHERE feature='1' ORDER BY Id DESC";
                        ...
                        while ($result = mysqli_fetch_array($run)) {
                            ...
                            $runSociety = $connection->query($societyQuery);
                            ...
                            echo "<td> <a href ='cancelFeature.php?id=$id'>" . $ft . "</a></td>";
