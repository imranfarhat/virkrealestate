                ...
                <table class="table table-bordered table-striped text-center">
                    ...
                    <tbody>
                        ...
                        while ($result = mysqli_fetch_array($run)) {
                            echo "<tr>";
                            echo "<td style='vertical-align:middle'>" . $result['Name'] . "</td>";
                            echo "<td style='vertical-align:middle'>" . $result['Email'] . "</td>";
                            echo "<td style='vertical-align:middle'>" . $result['Message'] . "</td>";
                            echo "</tr>";
                        }
                        ?>
                    </tbody>
