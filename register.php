		...
		<div class="mainBox">
			...
			<div class="box row container-fluid">
				<div class="left col-md-6 col-sm-12">
					<h2 class="text-center text-light">Virk Real Estetes<sup>&reg;</sup><br><small class="text-center text-light">Our Mission to Complete the Dream.
						Register Here to Acheived the Goal.</small></h2>
					</div>
					<div class="right col-md-6 col-sm-12">
						<div class="text-center">
							<br><img src="imgs/vrelogo.png" class="img-fluid"><br><br>
						</div>
						<form method="post">
							<table>
								<tr>
