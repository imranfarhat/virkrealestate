        ...
        <div class="container-fluid">
            <div class="row d-flex d-md-block flex-nowrap wrapper">
                ...
                <div class="list-group border-0 card text-center text-md-left">
                        <h4 class="list-group-item d-inline-block collapsed" data-parent="#sidebar"><img src="imgs/vrelogo.png" class="img-fluid" style="width:60px;height:60px;border-radius:100px;margin-left:50px;"><br> <span class="d-none d-md-inline text-center"><?php echo $adminName['Name']; ?></span></h4>
