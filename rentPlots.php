...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <?php
            $query = "SELECT * FROM ads WHERE status=1 and Purpose='Rent' ORDER BY Id DESC";
            ...
            ?>
            <?php
            $query = "SELECT * FROM ads WHERE status=2 and Purpose='Rent' ORDER BY Id DESC";
            $run = $connection->query($query);
            while ($data = mysqli_fetch_array($run)) {
                $id = $data['Id'];
                $images = $data['Imgs'];
            ...
            ?>
            <?php
            $query = "SELECT * FROM ads WHERE status=0 and Purpose='Rent' ORDER BY Id DESC";
            $run = $connection->query($query);
            while ($data = mysqli_fetch_array($run)) {
                $id = $data['Id'];
                $images = $data['Imgs'];
