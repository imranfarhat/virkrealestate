            ...
            <div class="row d-flex d-md-block flex-nowrap wrapper">
                ...
                <div> <?php
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                        ...
                        <a class="navbar-brand" onclick="admin()" href="#" style="margin-left: 10px;">Virk Real Estetes<sup>&reg;</sup></a>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <h3 class="text-center">Super Hot Ads</h3>
                <table class="table table-bordered table-striped text-center">
                    ...
                    <tbody>
                        ...
                        $ads = mysqli_num_rows($fireSelectQuery);
                        if ($ads >= 1) {
                            ...
                            while ($result = mysqli_fetch_array($run)) {
                                ...
                                if ($status == 1) {
                                    $st = "<div class='super'><i class='fas fa-pepper-hot'></i></div>";
                                }
                                echo "<tr>";
                                echo "<td style='vertical-align:middle'>" . $result['Purpose'] . "</td>";
                                echo "<td style='vertical-align:middle'>" . $result['Type'] . "</td>";
                                echo "<td style='vertical-align:middle'>" . $result['City'] . "</td>";
                                echo "<td style='vertical-align:middle'>" . $result['Society'] . "</td>";
